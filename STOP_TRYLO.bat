...
echo [2/5] Stopping Driver app (port 3001)...
call :kill_port 3001

echo [3/5] Stopping API server (port 4000)...
call :kill_port 4000
echo.

echo [4/5] Stopping PostgreSQL container...
...
echo [5/5] Checking for any remaining TRYLO Node.js processes...
