    ...
    <html lang="en" suppressHydrationWarning>
      ...
      <body>
        <div className="fixed inset-0 -z-10 bg-background">
          <div className="absolute left-1/2 top-0 h-[36rem] w-[64rem] -translate-x-1/2 rounded-full bg-teal-500/10 blur-[120px]" />
          <div className="absolute bottom-0 right-0 h-[28rem] w-[28rem] rounded-full bg-amber-500/5 blur-[100px]" />
        </div>
        <Providers>
